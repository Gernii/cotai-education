                    ...
                    >
                        ...
                        >
                            <div class="card h-full bg-primary">
                                <div
                                    class="card-body space-y-4 text-primary-content"
                                >
                                    <SectionTitle paddingBottom={false}
                                        >{m.needSupport()}?</SectionTitle
                                    >
                                    <div class="text-lg font-semibold">
                                        {m.needSupport_description()}
                                    </div>
                                    <button
                                        class="btn btn-outline border-primary-content text-primary-content"
                                    >
                                        {m.contactNow()}
                                    </button>
                                </div>
