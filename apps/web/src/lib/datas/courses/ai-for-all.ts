export const dataCourseAiForAll = {
    id: "ai-for-all",
    title: "AI for all",
    ...
    description:
        "Khoá học dành cho tất cả mọi người (từ cấp 3 trở lên) thực hành sáng tạo cùng các ứng dụng AI thú vị, qua đó hiểu các nguyên lý hoạt động của AI, các nguồn tài nguyên mã mở & lộ trình đào tạo để khai thác áp dụng, các tiềm năng to lớn cũng như các ảnh hưởng & hệ luỵ. Lưu ý: Khoá học không cần lập trình.",
    components: [],
